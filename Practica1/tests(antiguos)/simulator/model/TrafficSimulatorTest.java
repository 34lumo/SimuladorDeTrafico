...
class TrafficSimulatorTest {
	...
	void test_1() {
		...
		ts.addEvent(new NewJunction(1,"j1", new RoundRobinStrategy(10), new MoveFirstStrategy(), 0, 0));
		ts.addEvent(new NewJunction(1,"j2", new RoundRobinStrategy(10), new MoveFirstStrategy(), 0, 0));
		ts.addEvent(new NewJunction(1,"j3", new RoundRobinStrategy(10), new MoveFirstStrategy(), 0, 0));
		ts.addEvent(new NewCityRoad(1, "r1", "j1", "j2", 1000, 500, 100, Weather.SUNNY));
		ts.addEvent(new NewCityRoad(1, "r2", "j2", "j3", 1000, 500, 100, Weather.SUNNY));
		ts.addEvent(new NewVehicle(1,"v1", 50, 1, Arrays.asList("j1", "j2")));
		ts.addEvent(new NewVehicle(1,"v2", 50, 1, Arrays.asList("j1", "j2")));
		ts.addEvent(new NewVehicle(1,"v3", 50, 1, Arrays.asList("j1", "j2")));

		ts.addEvent(new SetWeather(3,Arrays.asList(new Pair<>("r1",Weather.CLOUDY),new Pair<>("r2",Weather.RAINY))));
		ts.addEvent( new SetContaminationClass(5, Arrays.asList(new Pair<>("v1",4),new Pair<>("v3",7))));
