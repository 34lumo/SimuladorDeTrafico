...
class NewVehicleEventBuilderTest {
	...
	static private TrafficSimulator createSim() {
		...
		NewJunctionBuilder jeb = new NewJunctionBuilder(lssFactory, dqsFactory);
		...
		NewCityRoadBuilder reb = new NewCityRoadBuilder();
	...
	void test_1() {
		...
		NewVehicleBuilder eb = new NewVehicleBuilder();
